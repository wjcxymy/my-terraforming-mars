...
export class Server {
  ...
  public static getPlayerModel(player: IPlayer): PlayerViewModel {
    ...
    const rv: PlayerViewModel = {
      ...
      genericDraftedCards: cardsToModel(player, player.genericDraftedCards),
      ...
      secondaryCorporationCard: player.secondaryCorporationCard ? cardsToModel(player, [player.secondaryCorporationCard]) : [],
  ...
  public static getGameOptionsAsModel(options: GameOptions): GameOptionsModel {
    return {
      ...
      sevenHeatVariant: options.sevenHeatVariant,
      doubleCorpVariant: options.doubleCorpVariant,
    };
  }
