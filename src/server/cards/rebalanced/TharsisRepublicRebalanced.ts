...
export class TharsisRepublicRebalanced extends CorporationCard {
  constructor() {
    super({
        ...
        renderData: CardRenderer.builder((b) => {
          ...
          b.corpBox('effect', (ce) => {
            ce.effect('When any city tile is placed, increase your M€ production 1 step. When you place a city tile, gain 3 M€.', (eb) => {
              eb.city({size: Size.SMALL, all}).colon().production((pb) => pb.megacredits(1)).nbsp;
