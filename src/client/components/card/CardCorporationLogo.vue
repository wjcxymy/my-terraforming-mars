<template>
  <div class="card-corporation-logo">
    ...
    <template v-else-if="title === CardName.INVENTRIX || title === CardName.INVENTRIX_REBALANCED">
...
const imageOnlyLogos: Map<CardName, string> = new Map([
  ...
  [CardName.HEAVYWORKS_CREED, 'card-heavyworks-creed-logo'],
  [CardName.DATA_COMMUNICATION_CENTER, 'card-data-communication-center-logo'],
]);
...
const imageLogosWithNames: Map<CardName, string> = new Map([
  ...
  [CardName.ABNORMAL_TITAN, 'card-abnormal-titan-logo'],
  [CardName.VOID, 'card-void-logo'],
]);
